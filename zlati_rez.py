...
# podano natančnost.
# =============================================================================
def natancni_priblizek(k):
    n = 1
    while abs(n - naslednji_priblizek(n)) > k:
        n = naslednji_priblizek(n)
    n = naslednji_priblizek(n)
    return n
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoxMDAwLCJ1c2VyIjo2NDUwfQ:1nRCjZ:WdhUJgdvKBFaYQIzXF3w68qctQ0'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoxMDAxLCJ1c2VyIjo2NDUwfQ:1nRCjZ:VnjRJ2RqppJYz7hID7F360JSFuo'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoxMDAyLCJ1c2VyIjo2NDUwfQ:1nRCjZ:_cVz1AmBn5JpZ4oxU4ZU4pz33uI'
        try:
    ...
    try:
        ...
        token = 'Token bb94d4de68f9aa9df1dbe331d4b81fa64430d9b3'
